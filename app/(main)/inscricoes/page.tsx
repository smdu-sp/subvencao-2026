...
const Inscricoes = () => {
  return (
    <div className="text-black max-w-6xl mx-auto px-4 mt-5 pt-11 bg-white flex flex-col gap-5">
      <h2 className="text-[#0a3297] text-[26px] font-bold">Chamamento Público nº 01/2025/SMUL</h2>
