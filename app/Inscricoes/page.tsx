    ...
    <div>
      <div className={`text-black max-w-6xl mx-auto px-4 mt-5 pt-11 bg-white ${dmSans.className}`}>
        <section className="flex flex-col max-w-4xl mx-auto w-full">
          <GoBack></GoBack>
          <h2 className="text-[#0a3297] text-[26px] pt-5.5 pb-5.5 font-bold">
          ...
          <h2 className={"text-[26px] mb-5 font-bold"}>
          ...
          <div className="text-[18px]">
            ...
            <p className="mb-5">
              Recomenda-se que os <strong>RESPONSÁVEIS PELOS IMÓVEIS</strong>{" "}
              solicitem a Senha Web com a devida antecedência, de modo que haja
              tempo hábil de sua liberação para que, assim, a{" "}
          ...
          <div className="text-[18px]">
            ...
            <p className="mb-5">
              ...
              preenchidos diretamente no Portal de Processos no momento da <strong>SOLICITAÇÃO</strong>. Portanto, não há necessidade de
              serem impressos ou anexados.
            </p>
            <p className="mb-5">
              Os modelos do{" "}
              <strong>
              ...
              deverão ser preenchidos antecipadamente e anexados ao final da <strong>SOLICITAÇÃO</strong>, nos campos exigidos.
            </p>
            <p className="mb-5">
              ...
              <strong>
                Sua solicitação só estará concluída quando, após a assinatura,
                for gerado um número de Processo no formato
                “6068.2025/xxxxxxx-x”.
              </strong>
            </p>
            <p className="mb-5">
